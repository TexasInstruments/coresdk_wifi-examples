...
This repository redistributes examples from TI's [SimpleLink WIFI
SDK](https://www.ti.com/tool/download/SIMPLELINK-WIFI-SDK). 
...
The WIFI SDK is provided as [Git
submodule](https://www.git-scm.com/docs/gitsubmodules) in its respective
subdirectory.

As a quick reference, you can initialize and update a Git submodule in
one step like this:
...
Once initialized and updated, you can refer to SDK's README.md and Release
Notes for details on how to download its dependencies, and build its libraries.

* [SimpleLink WIFI SDK
  README](https://github.com/TexasInstruments/simplelink-wifi-sdk/blob/main/README.md)
...
```bash
.../simplelink-coresdk_wifi-examples$ cd examples\rtos\LP_EM_CC35X1\drivers\adcsinglechannel\freertos\ticlang/
.../ticlang$ make
```
